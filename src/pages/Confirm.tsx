...
export function Confirm() {
    ...
    //Ele olha aqui se eu não mandei ou se mandei a flag "fromSubmit" falsa, se sim ele entra no if e faz esse Navigate que faz com que ele retorne para tela home
    ...
    return (
        <div className="bg-gray-500 lg:w-[512px] rounded-xl flex flex-col items-center p-10 gap-6">
            ...
            <p className="text-sm text-gray-200 text-center">Agora é apenas aguardar sua solicitação ser analisada e em breve o setor financeiro irá entrar em contato com você.</p>
